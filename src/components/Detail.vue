        ...
        <div class="main">
            <div class="course-info">
                ...
                <div class="wrap-right">
                    ...
                    <p class="data">{{course.students}}人在学&nbsp;&nbsp;&nbsp;&nbsp;课程总时长：45课时/89小时&nbsp;&nbsp;&nbsp;&nbsp;难度：{{course.level_name}}</p>
                    <div class="sale-time">
                    ...
                    <div class="buy">
                        ...
                        <div class="add-cart" @click="add_cart"><img src="/static/img/01.png" alt="">加入购物车</div>
                    </div>
                </div>
            </div>
                ...
                <div class="course-tab-list">
                    ...
                    <div class="tab-item" v-if="tabIndex==2">
                        ...
                        <div class="chapter-item" v-for="chapter in chapter_list" :key="chapter.id">
                            <p class="chapter-title"><img src="/static/img/03.png" alt="">{{chapter.name}}</p>
                            <ul class="lesson-list">
                                <li class="lesson-item" v-for="lesson in chapter.coursesections">
                                    ...
                                    <p class="time">{{lesson.duration}}<img src="/static/img/java.png"></p>
        ...
        data() {
            return {
                ...
                playerOptions: {
                    ...
                    poster: "../static/image/python.png", //视频封面图
        ...
        methods: {
            ...
            get_chapter_lesson() {
                this.$axios.get(this.$settings.HOST + "course/chapter/", {
                    ...
                    console.log(this.chapter_list,123465);
                }).catch(error => {
                    console.log(error);
                })
            },
